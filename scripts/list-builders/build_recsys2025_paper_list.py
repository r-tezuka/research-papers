#!/usr/bin/env python3
"""RecSys 2025 Accepted Contributions ページから論文リストを抽出して JSON に保存する。"""
...
DEFAULT_URL = "https://recsys.acm.org/recsys25/accepted-contributions/"
...
class RecSys2025Parser(HTMLParser):
    """RecSys 2025 Accepted Contributions ページ向けパーサー。"""
...
def parse_records(html: str) -> list[dict]:
    ...
    parser = RecSys2025Parser()
    parser.feed(html)
    return parser.records


def main() -> None:
    """RecSys 2025 の accepted contributions を JSON へ保存する。"""
    parser = argparse.ArgumentParser(description="Build RecSys 2025 accepted papers JSON")
    ...
    payload = {
        ...
        "year": 2025,
        "source_url": args.url,
        "dblp_query": "toc:db/conf/recsys/recsys2025.bht:",
        "papers": records,
    }
